  ...
  (function () {
    ($(
      ...
      $(document).on("click touchstart", function (n) {
        $(".slicknav_menu").hasClass("act") &&
          $(n.target).hasClass("slicknav_nav") &&
          $(".slicknav_btn").click();
      }),
      $(".counter-item [data-to]").length > 0 &&
        $(".counter-item [data-to]").each(function () {
          var n = $(this),
            o = n.offset().top;
          ($(window).scrollTop() > o - 800 &&
            !n.hasClass("counting") &&
            (n.addClass("counting"), n.countTo()),
      ...
      s =
        ...
        (i = function () {
          ...
          (n.on("click", function (n) {
            ...
            var t = o(this),
              i = t.hasClass("active"),
              l = i ? "all" : t.data("group");
            (i || o(".portfolio-sorting li a").removeClass("active"),
        ...
        }),
        {
          init: function () {
            (setTimeout(function () {
              ...
              o("#grid .col-md-4").slice(0, 4).show(),
              o("#loadMore").on("click", function (n) {
                (n.preventDefault(),
                  o("#grid .col-md-4:hidden")
                    .slice(0, 4)
                    .fadeIn()
                    .each(function () {
                      a.shuffle("appended", o(this));
                    }),
                  0 == o("#grid .col-md-4:hidden").length &&
                    o("#loadMore")
                      .addClass("disabled")
                      .html("No more to Load"));
              }),
              a.shuffle({
