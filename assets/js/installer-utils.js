...
async function fetchInstallerData() {
    try {
        const response = await fetch('https://api.github.com/repos/ComplementaryDevelopment/Complementary-Installer/releases');
        ...
        const exeAssets = release.assets.filter(asset => 
